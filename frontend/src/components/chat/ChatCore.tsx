...
═══════════════════════════════════════════════ */
export default function ChatCore({ portal = "farmer" }: { portal?: "farmer" | "industry" }) {
  const isFarmer = portal === "farmer";
  ...
  const [convos, setConvos] = useState<Convo[]>(isFarmer ? FARMER_CONVOS : INDUSTRY_CONVOS);
